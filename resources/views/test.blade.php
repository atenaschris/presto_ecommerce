...
class TNTSearchEngine extends Engine
{
     ...
     * @return Collection
     */
 public function map(Builder $builder, $results, $model,$withTrashed, $onlyTrashed)
{
...
class Builder
{
    ...
    public function paginate($perPage = null, $pageName = 'page', $page = null)
    {
        ...
        $results = $this->model->newCollection($engine->map(
            $this, $rawResults = $engine->paginate($this, $perPage, $page), $this->model,$this->withTrashed, $this->onlyTrashed
        )->all());
...
abstract class Engine
{
     ...
     * @return \Illuminate\Database\Eloquent\Collection
     */
    abstract public function map(Builder $builder, $results, $model,$withTrashed, $onlyTrashed);
    ...
    {
        return $this->map(
            $builder, $this->search($builder), $builder->model,$builder->withTrashed, $builder->onlyTrashed
        );
    }
}
...
//impostare su scout php questo true 'soft_delete' => true,
