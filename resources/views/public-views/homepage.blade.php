...
<div class="container">
    <div class="slider mt-n5">
        ...
        <div class="col-md-12">
            <a href="{{route('category.ads',['id'=>$category->id,'name'=>$category->name])}}" class="itm  custom-link text-white"
                style='background-image:url(/media/{{$category->name}}.jpg)'data-tilt>
                <div class="caption">
