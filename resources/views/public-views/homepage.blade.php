...
<div class="container">
    ...
    {{-- END_CARD --}}
    @if (Auth::user())
    <a href="{{ route('add.ads') }}" target="_blank" rel="noopener noreferrer"><button id="start-sell" class="da-btn-secondary btn-mobile ">Inizia a vendere</button></a>    
    @else
    <a href="{{ route('login') }}" target="_blank" rel="noopener noreferrer"><button id="start-sell" class="da-btn-secondary btn-mobile ">Inizia a vendere</button></a>   
    @endif
