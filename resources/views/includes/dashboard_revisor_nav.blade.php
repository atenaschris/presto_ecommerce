        ...
        <div class="nav flex-column nav-pills"  aria-orientation="vertical">
            ...
            <a class="nav-link nav-dashboard {{ Request::is('*/revisioning/ads') ? ' active' : "" }}" href="{{ route('revisor.to.be.revisioned.ads') }}" role="tab">
                <svg class="bi bi-bag" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h6 class="d-inline text-align-center">Annunci da Revisionare <span class="badge badge-secondary">{{\App\Advertise::toBeRevisionedCount()}}</span></h6></a>
            ...
            <a class="nav-link nav-dashboard {{ Request::is('*/undo') ? ' active' : "" }}" href="{{ route('revisor.undo.ads') }}" role="tab">
                <svg class="bi bi-person-check" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h6  class="d-inline text-align-center">Annunci Revisionati</h6>
            </a>
