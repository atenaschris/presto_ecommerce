...
<div class="col-2 d-none d-md-block">
    <div class="sticky-to-nav">
        <div class="nav flex-column nav-pills"  aria-orientation="vertical">
            ...
            <a class="nav-link nav-dashboard {{ Request::is('revisor-dashboard') ? ' active' : "" }}" href="{{ route('revisor.home',$user) }}" role="tab">
            ...
            <a class="nav-link nav-dashboard {{ Request::is('*/revisioning/ads') ? ' active' : "" }}" href="{{ route('revisor.to.be.revisioned.ads',$user) }}" role="tab">
                <svg class="bi bi-bag" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h6 class="d-inline text-align-center">{{ __('ui.annunci') }} {{ __('ui.darevisionare') }} <span class="badge badge-secondary">{{\App\Advertise::toBeRevisionedCount()}}</span></h6></a>

            <a class="nav-link nav-dashboard {{ Request::is('*/undo') ? ' active' : "" }}" href="{{ route('revisor.undo.ads',$user) }}" role="tab">
                <svg class="bi bi-person-check" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h6  class="d-inline text-align-center">{{ __('ui.annunci') }} {{ __('ui.revisionati') }}</h6>
            </a>

            <a class="nav-link nav-dashboard {{ Request::is("*revisor/edit/profile/*" ) ? ' active' : "" }}" href="{{ route('revisor.edit', $user) }}" role="tab">
              ...
              <h6  class="d-inline text-align-center">Modifica profilo </h6> </a>
